...
try {
  ...
  foreach ($requiredCss in @(
    ...
    '--dream-composer-bg: var(--dream-surface-raised)',
    '--dream-mask-opacity-light: .70',
    '--dream-mask-opacity-dark: .50',
    '--dream-global-art-opacity: .72',
    'calc(.42 * var(--dream-mask-opacity-dark))',
    '--dream-mask-color: oklch(0.98 0.004 35)',
    '--dream-mask-color: #2B2C42',
    'calc(86% * var(--dream-mask-opacity-light))',
    '--dream-immersive-composer',
    'background-position: var(--dream-art-position)',
    'html.codex-dream-skin::before',
    'background: color-mix(in oklab, var(--dream-surface) 70%, transparent)',
    '.dream-home',
    '.dream-home-utility',
    ':has(.dream-home-utility) .composer-surface-chrome',
    '[class~="px-toolbar"]:has(.composer-surface-chrome)',
    '--dream-send-bg: #6C7EEB',
    'button[aria-label="停止"] svg',
    'fill: currentColor',
    'dream-art-standard main.main-surface',
    'dream-art-standard .dream-task',
    'background: transparent !important',
    'dream-art-standard [class~="group/application-menu-top-bar"]',
    'calc(52% * var(--dream-mask-opacity-dark))',
    'calc(52% * var(--dream-mask-opacity-light))',
    'calc(92% * var(--dream-mask-opacity-dark))',
    'calc(72% * var(--dream-mask-opacity-light))',
    'main.main-surface:not(.dream-home-shell) .composer-surface-chrome',
    ':is(.dream-art-wide, .dream-art-standard):is(.dream-task-ambient, .dream-task-banner)',
    '--dream-composer-border: rgba(132, 148, 232, .86)',
    'border-color: var(--dream-composer-border)',
    'border: 1px solid var(--dream-composer-border) !important',
    'border-width: 1px !important',
    'box-shadow: none !important',
    'background-image: none !important',
    'app-shell-main-content-frame',
    'app-shell-main-content-top-fade',
    'main.main-surface.dream-home-shell .composer-surface-chrome',
