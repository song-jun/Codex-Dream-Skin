...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  recognizeSprite: (dataUrl: string) => ipcRenderer.invoke('sprite:recognize', dataUrl),
  selectDirectory: (defaultPath?: string) => ipcRenderer.invoke('dialog:selectDirectory', defaultPath),
  selectSpriteFiles: (mode: 'files' | 'directory') => ipcRenderer.invoke('dialog:selectSpriteFiles', mode),
  ...
  writeBinaryFile: (filePath: string, base64: string) => ipcRenderer.invoke('fs:writeBinaryFile', filePath, base64),
