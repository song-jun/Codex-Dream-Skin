...
.endpoint-row-v { display: flex; align-items: center; gap: 8px; width: 100%; cursor: pointer; }
.endpoint-row-v:hover { background: #f8fafc; }
.ep-checkbox { flex-shrink: 0; width: 14px; height: 14px; cursor: pointer; }
.ep-copy { flex-shrink: 0; margin-left: auto; font-size: 12px; }
...
.endpoint-item :deep(.el-checkbox__label) { width: 100%; white-space: normal; display: flex; align-items: center; gap: 8px; }
...
.ep-summary { font-size: 13px; flex: 1; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
</style>
